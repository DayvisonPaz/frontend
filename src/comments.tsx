...
function Comments(props:any  ){
  ...
  <div className='max-w-2xl bg-white rounded-lg border p-2 mx-auto mt-4 flex flex-col justify-center w-screen items-center'>
    <div className='flex items-center w-full'>
      <img
        className='rounded-full mr-4 w-9 h-9'
        src="https://img.freepik.com/psd-gratuitas/icone-3d-para-aplicativo-de-midia-social_23-2150049569.jpg?t=st=1710938452~exp=1710942052~hmac=3fd764f416367ca6a2f8b80aeb132d639a2a94194ffeb14fe4fa21b8788b4b3c&w=740"
        alt="profile pic"
      />
      <span className='font-bold whitespace-nowrap'>{e['nome']}</span>
    </div>
